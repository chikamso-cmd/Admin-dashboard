...
function previewImage(event) {
    ...
    document.getElementById('upload-image-edit').addEventListener('change', previewImageEdit);
    ...
    const CloseEdit = document.getElementById('myEdit');
...
// ! adds and removes an active class to the edit user modal
    ...
    if (OpenEdit.contains(e.target) && e.target !== openedit) {
